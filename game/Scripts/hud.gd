...
## The mandatory AI think-time readout, plus refusals and the result line.
## Turn and captures moved out: the player strip and the score box say both of
## those more clearly than a line of text did.
##
